...
// If there's no static modal markup on the page, skip this script's modal logic
if (modal) {
    ...
    function openModal(card) {
        ...
        if (modalImage) modalImage.style.background = card.dataset.image || 'linear-gradient(135deg, #ffefcc 0%, #ffb25f 100%)';
    ...
    console.info('No static modal found; skipping script modal logic.');
}